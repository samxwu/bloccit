...
RSpec.describe AdvertisementsController, type: :controller do
  ...
  describe "ADVERTISEMENT create" do
      it "increases the number of advertisements by 1" do
        request = Proc.new { post :create, advertisement: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: Random.rand(100)} }
        expect{request.call}.to change{Advertisement.count}.by(1)
      end
      
      it "assigns the new advertisement to @advertisement" do
        post :create, advertisement: {title: RandomData.random_sentence, body: RandomData.random_paragraph, price: Random.rand(100)}
